...
- (void)layoutSubviews {
    ...
    NSDictionary *lab = @{NSFontAttributeName: label.font};
    
    CGSize labelSize = [label.text sizeWithAttributes:lab];
    ...
    CGSize detailsLabelSize = [detailsLabel.text boundingRectWithSize:maxSize options: NSStringDrawingUsesLineFragmentOrigin attributes:attribute context:nil].size;
